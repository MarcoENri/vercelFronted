...
// ✅ Estilos del popper del DateTimePicker — mismo que FinalDefenseAdminPage
...
// ✅ Estilos del input — mismo que FinalDefenseAdminPage
                  ...
                  <Stack spacing={3}>
                    ...
                    {isCoordinator && (
                      <Paper elevation={0} sx={{ p: 3, borderRadius: "25px", border: "1px solid #e1e8ed", boxShadow: "0 4px 20px rgba(0,0,0,0.04)" }}>
                        ...
                        {/* ✅ DateTimePicker 24h — mismo estilo que FinalDefenseAdminPage */}
                        ...
                        <Button fullWidth variant="contained" onClick={handleCreateSlot} disabled={loading}
                          sx={{ bgcolor: VERDE_INSTITUCIONAL, borderRadius: "50px", fontWeight: 900, textTransform: "none", py: 1.3, boxShadow: `0 6px 20px ${VERDE_INSTITUCIONAL}44`, "&:hover": { bgcolor: "#006666", transform: "scale(1.01)" }, transition: "all 0.2s ease" }}>
                          Crear Slot
                        </Button>
                      </Paper>
                    )}
